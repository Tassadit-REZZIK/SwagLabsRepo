...
public class Utility {
    ...
    ////////////////
    public static boolean isSortedHighToLow(double[] array){
        for (int i=0; i>array.length -1; i++) {
            if(array[i] < array[i+1])
                return false;
        }
    ...
    public static boolean isSortedAtoZ(String[] array){
    ...
    public static boolean isSortedZtoA(String[] array){
        for(int i=0; i < array.length; i++)
        {
            for (int j=i+1; j < array.length; j++)
            {
...
/////////////////////////////////////
    ...
    public static String[] listToArrayOfString(List<String> list){
            String[] strList = new String[list.size()];
        for (int i = 0; i < list.size(); i++){
            strList[i] = String.valueOf(list.get(i));
        }
        return strList;
    }
